...
stoptime = 1.5;       %[a] total timespan of the problem
...
if Seaweed == "Sugar cane bagasse" %oxygen concentration changed to near zero to mimic anoxic basin
    dO2w=5e-6
end
